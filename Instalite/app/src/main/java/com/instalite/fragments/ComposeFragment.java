package com.instalite.fragments;
...
import com.instalite.TimelimeActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnTakepicture = view.findViewById(R.id.takePicture);
        btnSubmit = view.findViewById(R.id.submit);
        imgTaken = view.findViewById(R.id.myImage);
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.instalite.fileprovider", photoFile);
